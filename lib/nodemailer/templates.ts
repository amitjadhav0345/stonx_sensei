...
<head>
    ...
    <title>Welcome to Stonx Sensei</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://ik.imagekit.io/a6fkjou7d/logo.png?updatedAt=1756378431634" alt="Stonx Sensei Logo" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                            <img src="https://ik.imagekit.io/a6fkjou7d/dashboard-preview.png?updatedAt=1756378548102" alt="Stonx Sensei Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               Stonx Sensei HQ, 200 Market Street, San Francisco, CA 94105<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="https://stock-market-dev.vercel.app/" style="color: #CCDADC !important; text-decoration: underline;">Visit Stonx Sensei</a><br>
                                Â© 2025 Stonx Sensei
                            </p>
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to Stonx Sensei news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://Stonx Sensei.app" style="color: #CCDADC !important; text-decoration: underline;">Visit Stonx Sensei</a>
                                </p>
        ...
        <tr>
            <td align="center" class="mobile-outer-padding" style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="" alt="" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited Stonx Sensei in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit Stonx Sensei</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    Â© 2025 Stonx Sensei
                                </p>
...
export const MINIMAL_WELCOME_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Welcome</title>
  <style>
    body { background:#0b0b0b; color:#e5e7eb; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin:0; padding:0; }
    .container { max-width:600px; margin:0 auto; padding:32px 24px; }
    .card { background:#141414; border:1px solid #30333A; border-radius:12px; padding:28px; }
    .title { font-size:22px; line-height:1.3; margin:0 0 8px; color:#f3f4f6; }
    .subtitle { font-size:14px; color:#9ca3af; margin:0 0 16px; }
    .cta { display:inline-block; background:#f59e0b; color:#0b0b0b; text-decoration:none; font-weight:600; padding:10px 16px; border-radius:8px; margin-top:12px; }
...
<body>
  <div class="container">
    <div style="padding:8px 0 16px">
      <img class="logo" src="{{logoUrl}}" alt="{{appName}}" onerror="this.style.display='none'" />
    </div>
    <div class="card">
      <h1 class="title">Welcome to {{appName}}, {{name}} ðŸ‘‹</h1>
      <p class="subtitle">{{intro}}</p>
      <p class="footer">If you didnâ€™t sign up for {{appName}}, you can safely ignore this email.</p>
    </div>
  </div>
</body>
</html>`;
